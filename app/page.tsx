  ...
  return (
    <>
      <main className="relative z-0">
        ...
        >
          <div className="mx-auto flex h-[520px] w-full max-w-[1180px] flex-col items-center justify-center px-4 text-white">
            ...
            <div className="mt-6 w-full max-w-[920px] rounded-full p-2 shadow-xl">
